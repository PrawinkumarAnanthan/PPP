...
marked_values = np.full_like(right_facets,1)
...
T=fem.Constant(msh,default_scalar_type((6.74597356e+03,0)))
...
#ds = ufl.Measure('ds', domain=msh,subdomain_data=right_facets)
dx = ufl.Measure('dx')
